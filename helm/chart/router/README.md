...
[router](https://github.com/duan-jason/router) Rust Graph Routing runtime for Apollo Federation
...
```console
helm pull oci://ghcr.io/duan-jason/helm-charts/router --version 1.15.1
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/duan-jason/helm-charts/router --version 1.15.1 --values my-values.yaml
```
...
```console
helm show values oci://ghcr.io/duan-jason/helm-charts/router
```
...
| image.repository | string | `"ghcr.io/duan-jason/router"` |  |
| image.tag | string | `""` |  |
