...
> For the full list of options, see [`ApolloServer` options](/apollo-server/api/apollo-server#options). If you're using other options, additional steps might be necessary to replicate the same behavior. Please open a discussion on our [GitHub repository](https://github.com/duan-jason/router) so we can understand your needs and help you with a solution.
...
> If one of your `@apollo/gateway` plugins _does_ require a corresponding router customization, we encourage you to describe your use case in the Router repo's [GitHub discussions](https://github.com/duan-jason/router/discussions/). It might represent core functionality that the Apollo Router _should_ provide out of the box, and we can help discuss the design.
>
...
Examples for each are provided in their respective documentation, and in the [Router repo](https://github.com/duan-jason/router/tree/main/examples).

## Reporting migration issues

If you encounter a migration issue that isn't resolved by this article, please search for existing [GitHub discussions](https://github.com/duan-jason/router/discussions/) and start a new discussion if you don't find what you're looking for.
