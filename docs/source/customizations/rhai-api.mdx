...
For an example of interacting with `operation_name`, see the [examples/op-name-to-header directory](https://github.com/duan-jason/router/tree/main/examples/op-name-to-header).
...
There is a complete example of interacting with the response data in the [examples/data-response-mutate directory](https://github.com/duan-jason/router/tree/main/examples/data-response-mutate).
...
There is a complete example of interacting with the response errors in the [examples/error-response-mutate directory](https://github.com/duan-jason/router/tree/main/examples/error-response-mutate).
