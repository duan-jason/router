...
To demonstrate building a plugin, we'll walk through the [hello world example plugin](https://github.com/duan-jason/router/tree/main/examples/hello-world) in the Router repo.
