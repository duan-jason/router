...
>
> **If a native plugin seems necessary for your use case,** please [open an issue](https://github.com/duan-jason/router/issues) so we can investigate adding the required functionality to the stock router binary.
...
1. Use the `cargo-scaffold` command to create a project for your custom router:
   ...
   ```bash
   cargo-scaffold scaffold https://github.com/duan-jason/router.git -r apollo-router-scaffold/templates/base -t main
   ```
...
You can use the provided [Dockerfile](https://github.com/duan-jason/router/tree/main/apollo-router-scaffold/templates/base/Dockerfile) to build a release container.
