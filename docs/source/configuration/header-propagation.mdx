...
> If you require a configuration-based solution for response header propagation, [please leave a comment on our issue tracker](https://github.com/duan-jason/router/issues/1284).
...
> If you require a configuration-based solution for response header propagation, [please leave a comment on our issue tracker](https://github.com/duan-jason/router/issues/2444).
