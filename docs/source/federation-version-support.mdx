...
* Apollo GraphOS (for supergraphs that use [managed federation](./managed-federation/overview/))
...
> **Avoid router versions marked with ⚠️.** These versions include bugs described in the [changelog](https://github.com/duan-jason/router/blob/main/CHANGELOG.md).
...
<table>
    ...
    <tr>
        <td>
            v1.15.0 and later (<a href="https://github.com/duan-jason/router/releases">see latest releases</a>)
        </td>
        <td>
            2.4.1
        </td>
